...
namespace MyWebSite.Models
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private MyWebSiteRepository<Resimler> _resimRepository;
        ...
        public MyWebSiteRepository<Resimler> ResimRepository
        {
            get
            {
                if (_resimRepository == null)
                    _resimRepository = new MyWebSiteRepository<Resimler>(_context);
                return _resimRepository;
            }
        }
        public void Save()
        {
